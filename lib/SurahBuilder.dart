...
class SurahBuilder extends StatefulWidget {
 ...
 final  int ayah;
  ...
  const SurahBuilder(
      {Key? key, required this.sura, this.arabic, this.suraName, required this.ayah})
      : super(key: key);
                            ...
                            Future.delayed(const Duration(milliseconds: 100), () {
                              shareAyah(
                                "    بسم الله الرحمن الرحيم    "
                                      "  ${widget.arabic[index + previousVerses]['sura_name_ar']}     الايه رقم   ${widget.arabic[index + previousVerses]['aya_no']}    "
